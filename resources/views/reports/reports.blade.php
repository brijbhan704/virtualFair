 ...
 <div class="row">
            <div class="col-lg-8 col-md-12">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted mt-2 mb-2">ABOVE EXPECTATIONS</p>
                                    <p class="text-primary text-24 line-height-1 m-0">25</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    ...
                                    <p class="text-muted mt-2 mb-2">EXCELLENT</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    <i class="i-Money-2"></i>
                                    <p class="text-muted mt-2 mb-2">VERY GOOD</p>
                                    <p class="text-primary text-24 line-height-1 m-0">15</p>
                                </div>
                            </div>
                        </div>
						<div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    <i class="i-Money-2"></i>
                                    <p class="text-muted mt-2 mb-2">GOOD</p>
                                    <p class="text-primary text-24 line-height-1 m-0">12</p>
                                </div>
                            </div>
                        </div> 
						<div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="card card-icon mb-4">
                                <div class="card-body text-center">
                                    <i class="i-Money-2"></i>
                                    <p class="text-muted mt-2 mb-2">POOR</p>
                                    <p class="text-primary text-24 line-height-1 m-0">7</p>
                                </div>
                            </div>
                        </div>
			  ...
			  <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title">Feedback by Attendee</div>
