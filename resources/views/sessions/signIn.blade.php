                            ...
                            <div class="p-4">
                              <!-- auth-logo -->
                                ...
                                <div class="mt-4 text-right">
                                    ...
                                    <a href="https://smartevents.in" class="text-muted"><b>Powered by: <img src="{{asset('assets/images/smartevents-logo.png')}}" style="width: 78px;margin-top: -16px;margin-left: 14px;"></b></a>
                                </div>
                            </div>
                        </div>
