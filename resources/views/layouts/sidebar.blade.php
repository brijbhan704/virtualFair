<div class="side-content-wrap">
    <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar data-suppress-scroll-x="true">
        <ul class="navigation-left">
            ...
            <li class="nav-item {{ request()->is('all-leads') ? 'active' : '' }}">
                <a class="nav-item-hold" href="{{url('/')}}/all-leads">
             ...
             <!--li class="nav-item {{ request()->is('activity/*') ? 'active' : '' }}" >
                <a class="nav-item-hold" href="{{url('/')}}/activity">
                    <i class="nav-icon i-Suitcase"></i>
                    <span class="nav-text">Visitors Activity</span>
                </a>
                <div class="triangle"></div>
            </li-->
            <li class="nav-item {{ request()->is('profile') ? 'active' : '' }}" >
               <a class="nav-item-hold" href="{{url('/')}}/profile">
                   <i class="nav-icon i-Suitcase"></i>
                   <span class="nav-text">User Profile</span>
               </a>
               <div class="triangle"></div>
            </li>
            <li class="nav-item {{ request()->is('bothstaff') ? 'active' : '' }}" data-item="">
               <a class="nav-item-hold" href="{{url('/')}}/bothstaff">
                   <i class="nav-icon i-MaleFemale"></i>
                   <span class="nav-text">Counselor</span>
               </a>
               <div class="triangle"></div>
            </li>
             <li class="nav-item {{ request()->is('exhibitor') ? 'active' : '' }}" data-item="">
               <a class="nav-item-hold" href="{{url('/')}}/exhibitor">
                   <i class="nav-icon i-MaleFemale"></i>
                   <span class="nav-text">Exhibitor</span>
               </a>
               <div class="triangle"></div>
            </li>
            <li class="nav-item {{ request()->is('CareerSession') ? 'active' : '' }}" data-item="">
               <a class="nav-item-hold" href="{{url('/')}}/CareerSession">
                   <i class="nav-icon i-MaleFemale"></i>
                   <span class="nav-text">Career Session</span>
               </a>
               <div class="triangle"></div>
            </li>
