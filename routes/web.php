...
Route::any('dashboard', 'adminController@CheckLogin');
Route::get('logout', 'adminController@doLogout');

Route::group(['middleware' => ['Login']], function () {
  //download pdf
  Route::any('downloadpdf','HomeController@downloadpdf');
             
            Route::any('/profile', 'HomeController@ViewProfile');
            Route::any('/activity', 'HomeController@VisitorActivity');
            Route::any('/all-leads', 'HomeController@GetDataList');
            Route::any('/saveuserprofile', 'HomeController@Updateuserprofile');
            Route::any('getcourses', 'HomeController@getcourses');
            Route::any('AddCourseOffered', 'HomeController@AddCourseOffered');
                         
            Route::any('/bothstaff', 'HomeController@bothstaff');
            Route::any('/changeevent/{eventid}/{targetpage}', 'adminController@seteventasrequest');
            Route::any('/citylist', 'HomeController@callcitylist');

            Route::any('/addeditcourse', 'HomeController@addeditcourse');
            Route::any('/addchatbotdata', 'HomeController@addchatbotdata');
            Route::any('/addcategory', 'HomeController@addcategory');
            Route::any('/changeleadstatus', 'HomeController@changeleadstatus');
            Route::any('/showhistory', 'HomeController@showhistory');
            
            Route::any('/saveData','HomeController@saveData');
            Route::any('/unsaveData','HomeController@unsaveData');

            Route::any('/edituser', 'HomeController@edituser');
            Route::any('/adduser', 'HomeController@adduser');
            
            //exhibitor master
            Route::any('/exhibitor','HomeController@exhibitor_master');
            Route::any('/editexhibitor','HomeController@editexhibitor');
            Route::any('/Addexhibitor','HomeController@Addexhibitor');
            Route::any('/subcategorylist/{sm_id}', 'HomeController@subcategorylist');
            Route::any('/ex_subcategorylist/{id}','HomeController@ex_subcategorylist');
            Route::any('/changeStatus','HomeController@changeStatus');
            Route::any('showcounselordetail','HomeController@ShowCounselorDetail');
/*313 499 897*/
            //CounselorSession
            Route::any('CareerSession','HomeController@CounselorSession');
            Route::any('editCounselorSession','HomeController@editCounselorSession');
            Route::any('AddecounselorSession','HomeController@AddecounselorSession');
            Route::any('updateCounselorSession','HomeController@updateCounselorSession');
            Route::any('counselorchangeStatus','HomeController@counselorchangeStatus');
